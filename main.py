...
class Character:
    ...
    def attack(self):
        ...
        return (
            f'{self.name} нанес противнику урон, равный {value_attack}'
        )
...
def start_training(character: Character) -> str:
    ...
    Вовзращает сообщения о результатах цикла тренировки персонажа.
    """
    commands = {
...
def choice_char_class(char_name: str) -> Character:
    ...
    while approve_choice != 'y':
        selected_class = input(
            'Введи название персонажа, за которго хочешь играть: '
